...
const DASHBOARDS: Dash[] = [
  {
    ...
    subtitle: "Du cold email au rendez-vous, compté honnêtement.",
    dot: "#22ccff",
    stats: [
      { label: "Courriels envoyés", value: "6 108", delta: "+4,2 %" },
      { label: "Réponses réelles", value: "150", delta: "+2,5 %" },
      { label: "Rendez-vous", value: "49", delta: "+24 %" },
      { label: "Taux de réponse", value: "2,4 %", delta: "sain" },
    ],
    series: [12, 20, 16, 28, 22, 34, 30, 42, 38, 48],
    chart: "area",
  },
  {
    name: "Contenu · Marketing",
    subtitle: "Chaque tournage transformé en un mois de contenu.",
    dot: "#7c3aed",
    stats: [
      { label: "Vidéos produites", value: "14" },
      { label: "Publications planifiées", value: "48", delta: "+31 %" },
      { label: "Vues combinées", value: "312 k", delta: "+18 %" },
      { label: "Engagement", value: "6,1 %", delta: "+1,4 %" },
    ],
  ...
  {
    name: "CRM & Suivis",
    subtitle: "Aucun lead oublié, chaque relance déclenchée.",
    dot: "#2dd4bf",
    stats: [
      { label: "Leads reçus", value: "231", delta: "+12 %" },
      { label: "Qualifiés", value: "88" },
      { label: "Relances envoyées", value: "540", delta: "auto" },
      { label: "Conversions", value: "37", delta: "+9 %" },
    ],
    series: [20, 26, 24, 30, 28, 36, 40, 38, 46, 52],
    chart: "line",
  },
  {
    name: "Publicités Meta",
    subtitle: "Analyse en continu, décisions plus rapides.",
    dot: "#1877f2",
    stats: [
  ...
  },
  {
    ...
    subtitle: "Tout classé, rien oublié, chaque mois.",
    dot: "#22c55e",
    stats: [
      { label: "Factures classées", value: "342", delta: "auto" },
      { label: "En attente", value: "7" },
      { label: "Dépenses suivies", value: "58 k$" },
      { label: "Temps sauvé", value: "11 h / sem" },
    ],
    series: [10, 12, 11, 14, 13, 16, 15, 18, 17, 20],
    chart: "bars",
  },
];
