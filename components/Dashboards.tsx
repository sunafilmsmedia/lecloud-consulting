...
const DASHBOARDS: Dash[] = [
  {
    name: "💰 Le Directeur des ventes",
    subtitle: "Tes appels analysés, tes suivis déclenchés, tes dormants réactivés.",
    dot: "#f59e0b",
    stats: [
  ...
  {
    name: "🤝 Le Client Success Manager",
    subtitle: "Tes clients suivis, contents, et qui restent.",
    dot: "#2dd4bf",
    stats: [
      { label: "Clients suivis", value: "88" },
      { label: "Satisfaction", value: "94 %", delta: "+3 %" },
      { label: "Délai de réponse", value: "4 min", delta: "-38 %" },
      { label: "Rétention", value: "97 %", delta: "+2 %" },
    ],
    series: [20, 24, 22, 28, 26, 30, 29, 33, 32, 36],
    chart: "line",
  },
  {
    name: "📋 L'Adjointe de direction",
  ...
  {
    name: "🎯 Le CMO",
    subtitle: "Ton marketing en entier : contenu, publicités, SEO, email.",
    dot: "#1877f2",
    stats: [
      { label: "Coût par lead", value: "16,68 $", delta: "-11 %" },
      { label: "Contenus publiés", value: "48", delta: "+31 %" },
      { label: "Leads", value: "126", delta: "+18 %" },
      { label: "ROAS estimé", value: "4,3x", delta: "+0,6" },
    ],
    series: [12, 18, 15, 22, 26, 24, 32, 30, 38, 44],
    chart: "area",
  },
];
